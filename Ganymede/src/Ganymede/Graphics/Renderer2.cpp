...
namespace Ganymede
{
	...
	void Renderer2::DrawVertexObject(VertexObject& vertexObject, unsigned int numInstances, FrameBuffer& frameBuffer, Shader& shader, bool doDepthTest)
	{
	...
	void Renderer2::ClearFrameBuffer(FrameBuffer& frameBuffer, bool clearColor, bool clearDepth)
	{
