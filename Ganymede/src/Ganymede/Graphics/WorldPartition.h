...
namespace Ganymede
{
	...
	struct GANYMEDE_API WorldPartitionNodeID {
	...
	namespace std {
		...
		template <>
		struct hash<Ganymede::WorldPartitionNodeID> {
			size_t operator()(const Ganymede::WorldPartitionNodeID& k) const {
	...
	namespace Ganymede
	{
		...
		class GANYMEDE_API WorldPartitionNode
		{
		public:
			...
			void AddMeshWorldObjectInstance(const MeshWorldObjectInstance* mwoi);
		...
		class GANYMEDE_API WorldPartitionManager
		{
		public:
