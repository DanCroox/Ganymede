...
IF "%BUILD_CONFIG%"=="-GenerateProject" (
	set BUILD_PARAMS="-DBUILD_UNIT_TESTS=OFF -DBUILD_EXTRAS=OFF -DBUILD_BULLET2_DEMOS=OFF -DBUILD_OPENGL3_DEMOS=OFF -DBUILD_ENET=OFF -DBUILD_CLSOCKET=OFF -DUSE_GLUT=OFF -DBUILD_CPU_DEMOS=OFF"
